...
export class InitTasksSchema1766982969448 implements MigrationInterface {
    name = 'InitTasksSchema1766982969448'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tasks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "authorId" uuid NOT NULL, "authorName" character varying NOT NULL, "description" character varying, "dueDate" TIMESTAMP, "priority" "public"."tasks_priority_enum" NOT NULL DEFAULT 'LOW', "status" "public"."tasks_status_enum" NOT NULL DEFAULT 'TODO', "assignedUserIds" jsonb NOT NULL DEFAULT '[]', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_8d12ff38fcc62aaba2cab748772" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "task_audit_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "taskId" uuid NOT NULL, "action" character varying NOT NULL, "before" jsonb, "after" jsonb, "actorId" character varying, "actorName" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d535688da295a45639801474f16" PRIMARY KEY ("id"))`);
